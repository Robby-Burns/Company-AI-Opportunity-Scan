...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  return NextResponse.json({
    ...
    dimensionsLearned: report.dimensionsLearned,
    opportunities: report.opportunities,
    questionsWorthInvestigating: report.questionsWorthInvestigating,
    remainingUncertainty: report.remainingUncertainty,
