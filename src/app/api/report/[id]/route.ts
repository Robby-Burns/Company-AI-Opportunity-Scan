...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  return NextResponse.json({
    ...
    whyIdentified: report.whyIdentified,
    potentialImpact: report.potentialImpact,
    additionalSignals: report.additionalSignals,
    whatRemainsUnknown: report.whatRemainsUnknown,
    deepAssessmentQuestions: report.deepAssessmentQuestions,
    whatsNext: report.whatsNext,
